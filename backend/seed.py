...
def run():
    ...
    m1 = Merchant.objects.create(name="Acme Corp", balance_paise=15000000) # ₹150,000.00
    ...
    m2 = Merchant.objects.create(name="Stark Industries", balance_paise=10000) # ₹100.00
    LedgerEntry.objects.create(merchant=m2, amount_paise=10000, entry_type='customer_payment_simulation')
    
    # Merchant 3: Zero Balance
    m3 = Merchant.objects.create(name="Wayne Enterprises", balance_paise=0) # ₹0.00
